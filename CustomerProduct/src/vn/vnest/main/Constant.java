...
public class Constant {
	...
	private static String codeMarket = "";
	private static String sleep = "MINUTES";
	...
	public static String getCodeMarket() {
		return codeMarket;
	}
...
//	}
	...
	private static void init_(Properties appConfig) {
		if (appConfig != null) {
			...
			codeMarket = appConfig.getProperty("CODEMARKET", codeMarket);
			sleep = appConfig.getProperty("SLEEP", sleep);
