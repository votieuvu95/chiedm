...
public class UpdateMarket extends BaseBusiness {
	
	private static final Logger log = LogManager.getLogger(UpdateMarket.class);
	...
	public BaseResponse process(HttpHeaders headers, HashMap<String, String> params, String body) {
		...
		try {
			int code = MarketDBO.updateMarket(request);
