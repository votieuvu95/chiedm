...
public class MarketDataSource {
	...
	private MarketDataSource() throws IOException, SQLException,
			PropertyVetoException {
		Properties appConfig = new Properties();
		appConfig.load(new FileInputStream("conf/martket-sdk-db.properties"));
		try {
...
//			config.setInitSQL("SELECT 1 FROM DUAL");
	...
	public static MarketDataSource getInstance() throws IOException, SQLException,
			PropertyVetoException {
		if (datasource == null) {
